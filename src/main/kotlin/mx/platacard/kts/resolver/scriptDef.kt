...
import mx.platacard.kts.resolver.IvyResolver
import mx.platacard.kts.resolver.resolveFromAnnotations
import java.io.File
...
class SimpleMainKtsScriptDefinition :
    ScriptCompilationConfiguration(
        {
            ...
            jvm {
                ...
                val thisJarFile =
                    SimpleMainKtsScriptDefinition::class.java.classLoader
...
fun configureConstructorArgsFromMainArgs(
